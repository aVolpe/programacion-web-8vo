 ...
 * 
 */
@WebServiceClient(name = "services", targetNamespace = "http://services.ejb.webstock.com.py/", wsdlLocation = "http://localhost:8080/WebStockEJB/services/pago?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICES_QNAME = new QName("http://services.ejb.webstock.com.py/", "services");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebStockEJB/services/pago?wsdl");
     ...
     * 
     * @return
     *     returns PagoServiceWS
     */
    @WebEndpoint(name = "pagoPort")
    public PagoServiceWS getPagoPort() {
        return super.getPort(new QName("http://services.ejb.webstock.com.py/", "pagoPort"), PagoServiceWS.class);
    }
     ...
     */
    @WebEndpoint(name = "pagoPort")
    public PagoServiceWS getPagoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.ejb.webstock.com.py/", "pagoPort"), PagoServiceWS.class, features);
    }
